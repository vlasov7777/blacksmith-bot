...
register_command_handler(handler_userinfa_control, 'юзеринфа', ['админ','все'], 20,'Включить/отключить автовскрытие вкардов новичков ', 'юзеринфа [вкл/on/1/выкл/off/0]', ['юзеринфа вкл'])
