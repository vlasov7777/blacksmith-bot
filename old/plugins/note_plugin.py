...
register_command_handler(handler_note, 'блокнот', ['все','разное'], 10, 'Личный блокнот закреплённый за вашим жидом', 'блокнот [+/-/чисть] [параметры]', ['блокнот','блокнот чисть','блокнот + чёткий сайт - http://witcher-team.ucoz.ru/','блокнот - 2'])
