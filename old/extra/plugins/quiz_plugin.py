...
register_command_handler(handler_quiz_help, 'викторина', ['викторина','все'], 10, 'Вывод хелпа.', 'викторина', ['викторина'])
register_command_handler(handler_quiz_answer, 'ответ', ['викторина','все'], 80, 'Показывает правильный ответ <CHEAT>.', 'ответ', ['ответ'])
register_command_handler(handler_quiz_base_del, 'избазы', ['викторина','все'], 100, 'Удаляет всю БД или определённую запись', 'избазы [жид]', ['избазы foo@kabber.ru', 'избазы'])
register_command_handler(handler_quiz_start, 'игра', ['викторина','все'], 10, 'Запуск игры.', 'игра', ['игра'])
register_command_handler(handler_quiz_resend, 'повтори', ['викторина','все'], 10, 'Повтор текущего вопроса.', 'повтори', ['повтори'])
register_command_handler(handler_quiz_stop, 'стой', ['викторина','все'], 10, 'Остановка игры.', 'стой', ['стой'])
register_command_handler(handler_quiz_hint, 'помоги', ['викторина','все'], 10, 'Показать подсказку.', 'помоги', ['помоги'])
register_command_handler(handler_quiz_scores, 'счет', ['викторина','все'], 10, 'Показывает статистику (выводит ник, очки за последнюю игру, общие очки).', 'счет', ['счет'])
register_command_handler(handler_quiz_next, 'дальше', ['викторина','все'], 10, 'Следущий вопрос.', 'дальше', ['дальше'])
