...
register_command_handler(handler_vote_polloptions, 'голосование*', ['голосование','все'], 20, 'Управление опциями голосования. Всего 4 опции:\n1) closed - определяет, будет ли голосование открытым (только в общем чате) или закрытым (только приват)\n2) nicks - определяет, будут ли записывать ники голосующих, для последующей их выдачи вместе с результатами голосования\n3) admedit - определяет, будет ли администрация конференции иметь возможность редактировать голосование\n4) time - для определения времени (в секундах) в течении которого будет длиться голосование. 0 - ручная остановка', 'опции <опция> <состояние>', ['опции nicks 1','опции time 600'])
register_command_handler(handler_poll_start_stop, 'голосование!', ['голосование','все'], 20, 'Стартует голосование, останавливает голосование, все данные сохраняются до продолжения голосования.', 'голосование! <start/старт> / <stop/стоп> опции <опция> <состояние>', ['голосование! старт','опции nicks 1','опции time 600'])
register_command_handler(handler_vote_vote, 'мнение', ['голосование','все'], 10, 'Для подачи мнения в текущем голосовании.', 'мнение <мнение>', ['мнение да'])
register_command_handler(handler_vote_pollopinions, 'мнения', ['голосование','все'], 20, 'Отдаёт текущие результаты голосования в приват, не завершая голосования при этом.', 'мнения', ['мнения'])
register_command_handler(handler_vote_newpoll, 'голосование', ['голосование','все'], 20, 'Создаёт новое голосование или отправляет готовое голосование в текущий чат, если даны мнения.', 'голосование [вопрос]', ['голосование винды - сакс!', 'голосование'])
register_command_handler(handler_vote_pollopinions_control, 'пункт', ['голосование','все'], 20, 'Добавляет пункт (1!) к текущему голосованию, удаляет пункт из голосования', 'пункт <+/адд/-/делл> <твой_пункт/номер_пункта>', ['пункт + да','пункт- 5'])
register_command_handler(handler_vote_endpoll, 'итоги', ['голосование','все'], 20, 'Завершает голование и показывает его результаты.', 'итоги', ['итоги'])
