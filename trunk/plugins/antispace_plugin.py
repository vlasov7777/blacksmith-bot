...
register_command_handler(handler_antispace_control, 'антиспэйс', ['админ','все'], 20, 'Запрет на пробелы в никах, без параметра покажет текущее состояние\nBy WitcherGeralt', 'антиспэйс [вкл/on/1/выкл/off/0]', ['антиспэйс вкл', 'антиспэйс выкл'])
