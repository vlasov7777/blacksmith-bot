...
register_command_handler(handler_talkers, 'трёп', ['все','инфо'], 10, 'Выводит статистику болтунов, локальную/глобальную по нику/жиду, рейтинги болтунов локальный/глобальный', 'трёп [лококльный/loacal/глобальный/global] [nick/jid/мой/my]\nтрёп [топ/top] [локальный/local/глобальный/global]', ['трёп глобальный мой','трёп','трёп local WitcherGeralt','трёп топ глобальный','трёп глобальный WitcherGeralt@jabber.ru'])
