...
register_command_handler(handler_features_get, 'фичи', ['инфо','все'], 10, 'Показывает, какие XEP\'ы Jabber\'a подерживает клиент определённого юзера или жида, без параметра покажет твои фичи', 'фичи [nick/jid]', ['фичи','фичи guy','фичи guy@jabber.aq/Home','фичи guys@conference.jabber.aq/guy'])
