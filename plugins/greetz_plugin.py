...
register_command_handler(handler_greet, 'превед', ['все','фан'], 20, 'Добавляет приветствие для определённого ника или жида', 'превед [ник/жид] [=] [нет/none/show/*/приветствие]', ['превед guy = something','превед guy@jabber.aq = anything','превед guy = none'])
