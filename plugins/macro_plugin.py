...
register_command_handler(handler_local_macro, 'макро', ['макро','все'], 20, 'Добавить/удалить макро, открыть макро, установить доступ к макросу !!!(При добавлении макро должно быть заключено в апострофы ``)', 'макро [+/-/*/acc/адд/дел/инфо/доступ] [название] [`макро`]', ['макро + глюк `сказать /me подумал, что все глючат`','макро - глюк','макро * глюк','макро доступ глюк 10'])
register_command_handler(handler_global_macro, 'глобмакро', ['макро','все'], 100, 'Добавить/удалить макро глобально, открыть макро, установить доступ к макросу !!!(При добавлении макро должно быть заключено в апострофы ``)', 'глобмакро [+/-/*/acc/адд/дел/инфо/доступ] [название] [`макро`]', ['глобмакро + глюк `сказать /me подумал, что все глючат`','глобмакро - глюк','глобмакро * глюк','глобмакро доступ глюк 20'])
register_command_handler(macrolist_handler, 'макролист', ['макро','все'], 10, 'Выводится список глобальных и локальных макросов', 'макролист', ['макролист'])
register_command_handler(macroaccess_handler, 'макродоступ', ['макро','все'], 10, 'Посмотреть доступ определённому макро', 'макродоступ [макро]', ['макродоступ глюк'])
