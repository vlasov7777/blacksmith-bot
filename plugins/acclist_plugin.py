...
register_command_handler(local_acclist, 'доступы*', ['админ','все'], 20, 'Вывод списка локальных доступов', 'доступы*', ['доступы*'])
register_command_handler(global_acclist, 'доступы', ['суперадмин','все'], 80, 'Вывод списка глобальных доступов', 'доступы', ['доступы'])
