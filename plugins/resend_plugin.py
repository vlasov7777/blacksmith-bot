...
register_command_handler(handler_resend, 'направь', ['все','суперадмин'], 100, 'Перенаправляет ответ на команду определённо юзеру', 'направь [nick] [команда] [параметры]', ['направь ]{vich ботап'])
